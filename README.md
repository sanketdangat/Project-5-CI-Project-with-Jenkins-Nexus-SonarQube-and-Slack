...
```sh
git clone -b ci-jenkins git@github.com:sanketdangat/vprofileproject-all.git
```

### Git Code Migration

1. Run command ssh-keygen 
2. Copy id_rsa.pub & paste in Github, Go to Settings > SSH and GPG keys > paste key
2. Run command ssh -T git@github.com (is says you have succesfully authenticated)
3. git clone -b ci-jenkins git@github.com:sanketdangat/vprofileproject-all.git
4. mv vprofileproject-all <private_repo_name>
5. cd <private_repo_name>
6. cat .git/config
7. git remote set-url origin <copy_private_ssh_url>
8. git branch -c main
9. git checkout main
10. git checkout ci-jenkins
